...
<body>
    <header>SURVEY LAYANAN SEKOLAH</header>
    <div class="main-wrapper">
        <div class="container">
            ...
            <form onsubmit="event.preventDefault(); submitForm();">
                ...
                <div class="options">
                    <div class="option" onclick="setRating(5, this)">
                        ...
                        <img src="icon/sangat-puas.png" alt="Sangat Puas">
                    ...
                    <div class="option" onclick="setRating(4, this)">
                        ...
                        <img src="icon/puas.png" alt="Puas">
                    ...
                    <div class="option" onclick="setRating(3, this)">
                        ...
                        <img src="icon/cukup.png" alt="Cukup">
                    ...
                    <div class="option" onclick="setRating(2, this)">
                        ...
                        <img src="icon/kurang.png" alt="Kurang Puas">
                    ...
                    <div class="option" onclick="setRating(1, this)">
                        ...
                        <img src="icon/tidak-puas.png" alt="Tidak Puas">
            ...
            <div class="rekap-link">
                <button type="button" class="btn btn-orange" onclick="submitForm()">✉ SIMPAN PENDAPAT</button>
