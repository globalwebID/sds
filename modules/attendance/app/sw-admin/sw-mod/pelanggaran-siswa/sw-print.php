  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <h3 class="text-center" style="margin:0px">PELANGGARAN SISWA</h3>
          ...
          <table class="datatable mt-3">
              ...
              <tbody>';
                ...
                <tr>
                  ...
                  <td>'.strip_tags($data_pelanggaran['bentuk_pelanggaran']??'-').'</td>
                  <td class="text-center">'.$data_pelanggaran['bobot'].'</td>
                  <td>'.strip_tags($data_guru['nama_lengkap']??'-').'</td>
                  <td>'.tanggal_ind($data_pelanggaran['tanggal']??'-').'</td>
                </tr>';
                }
              echo'
              </tbody>
