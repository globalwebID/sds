...
$query_sanksi = "SELECT sanksi_pelanggaran.*, user.nama_lengkap,user.kelas 
                 ...
                 $filter AND user.user_id='{$data_siswa['user_id']}'
...
WHERE id < $id $filter AND user_id='{$data_siswa['user_id']}' ORDER BY id DESC";
...
$query_sanksi = "SELECT sanksi_pelanggaran.*, user.nama_lengkap,user.kelas 
                 FROM sanksi_pelanggaran 
                 LEFT JOIN user ON user.user_id = sanksi_pelanggaran.user_id
                 WHERE id < $id $filter AND user.user_id='{$data_siswa['user_id']}'
