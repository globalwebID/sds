...
echo'
<div class="footer s-widodo.com" style="display:none">
    <div class="appBottomMenu s-widodo.com" style="background: transparent;">
        <a href="'.$base_url.'" class="item s-widodo.com">
            <div class="col s-widodo.com" style="display:none">
        ...
        <a href="javascript:void(0);" class="item s-widodo.com">
            <div class="col s-widodo.com">
                <div class="action-button large s-widodo.com" style="border: 1px solid lightsteelblue;">
                    <span class="material-icons s-widodo.com">holiday_village</span>
                </div>
            </div>
        </a>
